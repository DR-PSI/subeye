...
def score_device(hourly: list[float], tpl_id: str, value: float, device_id: str) -> Result:
    tpl = TEMPLATES.get(tpl_id, TEMPLATES["temp"])
        ...
        for doc in docs:
            ...
            if r.score is not None:
                ...
                rows.append({"label": label, "value": round(value, 1),
                             "unit": TEMPLATES[tpl_id]["unit"], "score": r.score,
